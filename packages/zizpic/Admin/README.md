![Inventory Banner]
(https://github.com/zizpic/admin/blob/master/zizpic-banner.jpg)

[![Travis CI](https://img.shields.io/travis/zizpic/admin.svg?style=flat-square)](https://travis-ci.org/zizpic/admin)
[![Scrutinizer Code Quality](https://img.shields.io/scrutinizer/g/zizpic/admin.svg?style=flat-square)](https://scrutinizer-ci.com/g/zizpic/admin/?branch=master)
...
[![Latest Stable Version](https://img.shields.io/packagist/v/zizpic/admin.svg?style=flat-square)](https://packagist.org/packages/zizpic/admin)
[![Total Downloads](https://img.shields.io/packagist/dt/zizpic/admin.svg?style=flat-square)](https://packagist.org/packages/zizpic/admin)
[![License](https://img.shields.io/packagist/l/zizpic/admin.svg?style=flat-square)](https://packagist.org/packages/zizpic/admin)

## Index

[![Join the chat at https://gitter.im/zizpic/admin](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/zizpic/admin?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
Inventory is a fully tested, PSR compliant Laravel zizpic solution. It provides the basics of zizpic management using Eloquent such as:
...
All movements, stocks and zizpic items are automatically given the current logged in user's ID. All zizpic actions
such as puts/removes/creations are covered by Laravel's built in database transactions. If any exception occurs
during an zizpic change, it will be rolled back automatically.
